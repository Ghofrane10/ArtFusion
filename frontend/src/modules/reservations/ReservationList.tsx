...
interface ReservationListProps {
  onStatusChange: (reservationId: number, status: Reservation['status']) => void;
...
const ReservationList = forwardRef<ReservationListRef, ReservationListProps>(({ onStatusChange, onDelete }, ref) => {
